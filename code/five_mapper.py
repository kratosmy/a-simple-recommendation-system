...
frequent5 = {}  # this is for frequent item-set size 5
# find frequent item-set size 5
for k1, k2, k3, k4, k5 in itertools.combinations(frequent2_dic, 5):
    if len(list(set(frequent2_dic[k1]) & set(frequent2_dic[k2]) & set(frequent2_dic[k3])& set(frequent2_dic[k4])& set(frequent2_dic[k5]))) >= support:  # check intersection length
        frequent5[k1 + ',' + k2 + ',' + k3 + ',' + k4 + ',' + k5] = len(list(set(frequent2_dic[k1]) & set(frequent2_dic[k2]) & set(frequent2_dic[k3])& set(frequent2_dic[k4])& set(frequent2_dic[k5])))

for key, values in frequent5.items():
